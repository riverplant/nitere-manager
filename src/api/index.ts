...
export default {
 ...
 //获取订单列表
  ...
  getCouponList( params:Coupon.Params ) {
    return request.get<Coupon.Vo[]>('http://127.0.0.1:8080/coupon/list', params)
  },
   
  createCoupon(params: Coupon.CreateParams) {
    return request.post('http://127.0.0.1:8080/coupon', params)
  },

  editCoupon(params: Coupon.EditParams) {
    return request.put('http://127.0.0.1:8080/coupon', params)
  },

    //删除
    delCoupon(params: { id: string }) {
      return request.post('http://127.0.0.1:8080/coupon/delete', params)
    },

    getAllActiveCoupons() {
      return request.get<Coupon.Vo[]>('http://127.0.0.1:8080/coupon/allActive')
    }
